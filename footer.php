        ...
        <div class="footer__inner">
          <div class="footer__up">
            <div class="footer__left">
              <a href="/" class="header__logo">
                <p class="logo__left">
                  Work<span class="logo__right">out</span>
                </p>
            ...
            <div class="footer__middle">
              <div class="footer__middle-info">
                <h5 class="footer__middle-label">Info</h5>
              ...
              <div class="footer__middle-get">
                <h5 class="footer__middle-label">Get in touch</h5>
                <ul class="footer__middle-list">
              ...
              <form class="footer__form" action="/subscribe" method="post">
                <label class="footer__form-label"
                  >subscribe to our newsletter
                        <!-- <?php echo do_shortcode('[contact-form-7 id="f8b0499" mail="egor.goldenrash@gmail.com" title="Контактная форма 1"]') ?> -->

                        <input class="footer__form-input" type="text" placeholder="Type Your Email Here" name="email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" required>
          ...
          <div class="footer__down">
            <p class="footer__copyright-text">
              Copyright &#169; 2021 Enisson Lemos | All right reserved
            </p>
            <a class="footer__copyright-terms" href="#" target="_blank"
              >Terms & Conditions</a
            >
          </div>
        </div>
